...
Shader "BOXOPHOBIC/The Vegetation Engine/Default/Cross Standard Lit"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float saferPower1624_g49638 = abs( saturate( dotResult785_g49638 ) );
			#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch1602_g49638 = 0.0;
			#else
				float staticSwitch1602_g49638 = ( pow( saferPower1624_g49638 , _SubsurfaceAngleValue ) * _SubsurfaceScatteringValue );
			#endif
			half Mask_Subsurface_View782_g49638 = staticSwitch1602_g49638;
			half3 Subsurface_Approximation1693_g49638 = ( Subsurface_Color1722_g49638 * Subsurface_Intensity1752_g49638 * Subsurface_Mask1557_g49638 * Mask_Subsurface_View782_g49638 );
			half3 Blend_AlbedoAndSubsurface149_g49638 = ( Blend_AlbedoColored863_g49638 + Subsurface_Approximation1693_g49638 );
...
Node;AmplifyShaderEditor.RangedFloatNode;129;-1968,-896;Half;False;Property;_IsStandardShader;_IsStandardShader;199;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=FCB5E0D082CD1D2CF57E7DF7344C7F03519CEE3E
