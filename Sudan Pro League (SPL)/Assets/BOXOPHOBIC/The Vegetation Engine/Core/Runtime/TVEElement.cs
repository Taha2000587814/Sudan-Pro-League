...
namespace TheVegetationEngine
{
    ...
    public class TVEElement : StyledMonoBehaviour
    {
        ...
        void GetMaterialParameters()
        {
            ...
            {
                useVertexColorDirection = elementMaterial.GetInt(TVEConstants.ElementDirectionMode);
            }
        ...
        void DrawGizmos(bool selected)
        {
            ...
            if (isSelected)
            {
                ...
                {
                    if (elementMaterial.shader.name.Contains("Control") || elementMaterial.shader.name.Contains("Direction") || elementMaterial.shader.name.Contains("Turbulence"))
                    {
